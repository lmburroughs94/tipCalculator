...
function totalAmt() {
  alert(calculateTip(total));
  var billAmt = document.getElementById("billamt").value;

  //Calculate total per person 
  totalAmt = total + billAmt
...
//experimenting with Full amount
//document.getElementById("totalAmt").innerHTML = "$" + tip(totalAmt).toFixed(2);


//click to call function
document.getElementById("calculate").onclick = function () {
  calculateTip(); totalAmt();
